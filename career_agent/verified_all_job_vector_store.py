"""Canonical Qdrant indexer for the strict-coverage all-job corpus."""
...
COLLECTION_NAME = "career_agent_all_jobs_10k_verified_v1"
DEFAULT_STORAGE = Path(__file__).resolve().parents[1] / "qdrant_storage" / "career_agent_all_jobs_10k_verified_v1"
...
class VerifiedAllJobVectorStore:
