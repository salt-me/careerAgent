"""Search path for the indexed all-job public JD corpus."""
...
from .large_vector_store import COLLECTION_NAME, DEFAULT_STORAGE
from .vector_retrieval import MODEL_NAME


@dataclass(frozen=True)
class LargeSearchHit:
    id: str
    title: str
    company: str
    position: str
    ...
    def search(
        ...
        *,
        ...
        if not self.is_ready():
            raise RuntimeError("All-job vector store is not indexed. Run LargeJobVectorStore().rebuild().")
