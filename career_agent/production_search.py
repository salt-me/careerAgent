"""Semantic retrieval for the canonical production JD collection."""
...
from .production_vector_store import COLLECTION_NAME, DEFAULT_STORAGE
...
class ProductionJobSearchStore:
    ...
    def search(
        ...
        if not self.is_ready():
            raise RuntimeError("Production vector store is not indexed. Run ProductionJobVectorStore().rebuild().")
