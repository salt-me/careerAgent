"""Canonical HTTP API for the strict-coverage 10k all-job corpus."""
...
from .verified_all_job_search import VerifiedAllJobSearchStore
...
app = FastAPI(title="CareerAgent Verified All-Job Public JD Service", version="1.0.0")
store = VerifiedAllJobSearchStore()
