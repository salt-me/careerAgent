"""HTTP API for the verified 10k all-job corpus and its Qdrant index."""
...
from .large_corpus import large_coverage_report, load_large_job_records
from .large_search import LargeJobSearchStore
...
app = FastAPI(title="CareerAgent All-Job Public JD Service", version="1.0.0")
store = LargeJobSearchStore()


def _records_by_id() -> dict[str, dict]:
    records, _ = load_large_job_records()
