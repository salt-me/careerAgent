"""CLI for the retry-safe CC0 Open Jobs corpus import."""
...
from .open_jobs_cc0_import import DEFAULT_MANIFEST, DEFAULT_OUTPUT
from .open_jobs_cc0_import_v2 import import_subset


def main() -> None:
    parser = argparse.ArgumentParser(description="Import a retry-safe 10,000-record CC0 JD subset")
